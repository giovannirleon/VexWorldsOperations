...
3. Docker Desktop on macOS normally does not require `sudo` for `docker` or `docker compose`
4. verify it works:
...
If you want to apply the Docker group change immediately in the current shell:
